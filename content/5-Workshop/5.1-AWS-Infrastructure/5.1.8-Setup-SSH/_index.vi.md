...
Private key được giữ trên Automation Server và không đưa vào Managed Nodes.
...
Nếu hiển thị fingerprint của key, Automation Server có thể sử dụng key thông qua SSH Agent trong khi private key thực tế vẫn nằm trên máy Windows.
...
Automation Server hiện đã có thể SSH tới hai Managed Nodes bằng SSH key. Đây là nền tảng để bước tiếp theo cấu hình **Ansible Inventory** và để Ansible bắt đầu quản lý các Managed Nodes.
